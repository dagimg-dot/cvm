...
curl -L -o $HOME/.local/bin/cvm https://github.com/dagimg-dot/cvm/releases/download/v1.4.0/cvm.sh
...
```bash
curl -L -o cvm.sh https://github.com/dagimg-dot/cvm/releases/download/v1.4.0/cvm.sh
chmod +x cvm.sh
